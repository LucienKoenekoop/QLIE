...
for XXXX in structures:
    ...
    ligand = glob.glob('*.pdb')[0].strip('.pdb')
    os.system('python /home/koenekoop/software/qligfep/QLIE_conv.py -l '+ligand+' -S protein -P CSB -C CSB -T 298 -r 10 -f OPLS2015')
    ...
    os.system('python /home/koenekoop/software/qligfep/QLIE_conv.py -l '+ligand+' -S water -P CSB -C CSB -T 298 -r 10 -f OPLS2015 -R 25')
